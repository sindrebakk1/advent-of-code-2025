...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `1.0ms` | `1.3ms` |
| [Day 2](./src/bin/02.rs) | `9.8ms` | `25.5ms` |
| [Day 3](./src/bin/03.rs) | `57.9µs` | `73.9µs` |
| [Day 4](./src/bin/04.rs) | `46.1µs` | `821.1µs` |
| [Day 5](./src/bin/05.rs) | `94.6µs` | `40.9µs` |
| [Day 6](./src/bin/06.rs) | `72.9µs` | `276.9µs` |
| [Day 7](./src/bin/07.rs) | `90.0µs` | `26.4µs` |
| [Day 8](./src/bin/08.rs) | `52.8ms` | `50.2ms` |
